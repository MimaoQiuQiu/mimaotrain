    ...
    <section className="contact">
      <div className="container contact__container">
        <div className="contact__wrapper">
          <a href="mailto:shuaixinli@icloud.com" target="_blank" rel="noreferrer noopener"><MdEmail/></a>
          <a href="http://m.me/shuaixin.li.7" target="_blank" rel="noreferrer noopener"><BsMessenger/></a>
